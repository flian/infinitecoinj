...
import com.google.infinitecoinj.net.ClientConnectionManager;
import com.google.infinitecoinj.net.NioClientManager;
import com.google.infinitecoinj.net.discovery.PeerDiscovery;
import com.google.infinitecoinj.net.discovery.PeerDiscoveryException;
import com.google.infinitecoinj.script.Script;
import com.google.infinitecoinj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.infinitecoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.infinitecoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.infinitecoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.infinitecoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.infinitecoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.infinitecoinj.core.Peer#ping()}.
     */
