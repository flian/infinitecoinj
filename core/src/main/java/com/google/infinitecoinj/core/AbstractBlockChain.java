 ...
 * the lightweight SPV mode, a {@link com.google.infinitecoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.infinitecoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
