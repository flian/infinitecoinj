...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.infinitecoinj.script.Script, ECKey, com.google.infinitecoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.infinitecoinj.core.Transaction.SigHash, boolean)}
