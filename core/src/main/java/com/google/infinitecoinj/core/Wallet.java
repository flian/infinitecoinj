...
import com.google.infinitecoinj.core.TransactionConfidence.ConfidenceType;
import com.google.infinitecoinj.crypto.KeyCrypter;
import com.google.infinitecoinj.crypto.KeyCrypterException;
import com.google.infinitecoinj.crypto.KeyCrypterScrypt;
import com.google.infinitecoinj.script.Script;
import com.google.infinitecoinj.script.ScriptBuilder;
import com.google.infinitecoinj.script.ScriptChunk;
import com.google.infinitecoinj.store.UnreadableWalletException;
...
import com.google.infinitecoinj.wallet.*;
import com.google.infinitecoinj.wallet.WalletTransaction.Pool;
...
import static com.google.infinitecoinj.core.Utils.bitcoinValueToFriendlyString;
import static com.google.infinitecoinj.core.Utils.bitcoinValueToPlainString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.infinitecoinj.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.infinitecoinj.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.infinitecoinj.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.infinitecoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.infinitecoinj.wallet.WalletFiles.Listener)}
     ...
     * of {@link com.google.infinitecoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.infinitecoinj.crypto.KeyCrypter,
     ...
     * {@link com.google.infinitecoinj.crypto.KeyCrypterScrypt}.
     *
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.infinitecoinj.crypto.KeyCrypter,
     ...
     * you can use {@link com.google.infinitecoinj.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.infinitecoinj.core.TransactionBroadcaster broadcaster) {
