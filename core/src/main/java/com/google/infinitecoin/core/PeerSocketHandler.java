...
import com.google.infinitecoin.net.AbstractTimeoutHandler;
import com.google.infinitecoin.net.MessageWriteTarget;
import com.google.infinitecoin.net.StreamParser;
 ...
 * {@link com.google.infinitecoin.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.google.infinitecoin.net.NioClient} or
     * {@link com.google.infinitecoin.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
