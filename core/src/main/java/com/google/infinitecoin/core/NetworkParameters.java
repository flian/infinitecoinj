...
import com.google.infinitecoin.params.*;
...
public abstract class NetworkParameters implements Serializable {
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.google.infinitecoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.google.infinitecoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.google.infinitecoin.core.AlertMessage}s. You can use {@link com.google.infinitecoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
