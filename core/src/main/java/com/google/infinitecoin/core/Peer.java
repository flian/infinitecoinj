...
import com.google.infinitecoin.store.BlockStore;
 ...
 * {@link com.google.infinitecoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.infinitecoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.google.infinitecoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.infinitecoin.net.StreamParser)}
     * or
     * {@link com.google.infinitecoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.infinitecoin.net.StreamParser, int)}.</p>
     *
     ...
     * Once the pong is received the value returned by {@link com.google.infinitecoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.infinitecoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.infinitecoin.core.Peer#ping()} has never
