 ...
 * the lightweight SPV mode, a {@link com.google.infinitecoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.infinitecoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
