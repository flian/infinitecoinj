...
import com.google.infinitecoin.script.ScriptOpCodes;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.infinitecoin.script.Script, ECKey, com.google.infinitecoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.infinitecoin.core.Transaction.SigHash, boolean)}
