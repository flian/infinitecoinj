...
package com.google.infinitecoin.core;

import com.google.infinitecoin.core.TransactionConfidence.ConfidenceType;
import com.google.infinitecoin.crypto.KeyCrypter;
import com.google.infinitecoin.crypto.KeyCrypterException;
import com.google.infinitecoin.crypto.KeyCrypterScrypt;
import com.google.infinitecoin.script.Script;
import com.google.infinitecoin.script.ScriptBuilder;
import com.google.infinitecoin.script.ScriptChunk;
import com.google.infinitecoin.store.UnreadableWalletException;
import com.google.infinitecoin.store.WalletProtobufSerializer;
import com.google.infinitecoin.utils.ListenerRegistration;
import com.google.infinitecoin.utils.Threading;
import com.google.infinitecoin.wallet.*;
import com.google.infinitecoin.wallet.WalletTransaction.Pool;
...
import static com.google.infinitecoin.core.Utils.bitcoinValueToFriendlyString;
import static com.google.infinitecoin.core.Utils.bitcoinValueToPlainString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.infinitecoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.infinitecoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.infinitecoin.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.infinitecoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.infinitecoin.wallet.WalletFiles.Listener)}
     ...
     * of {@link com.google.infinitecoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.infinitecoin.crypto.KeyCrypter,
     ...
     * {@link com.google.infinitecoin.crypto.KeyCrypterScrypt}.
     *
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.infinitecoin.crypto.KeyCrypter,
     ...
     * you can use {@link com.google.infinitecoin.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.infinitecoin.core.TransactionBroadcaster broadcaster) {
