...
import com.google.infinitecoin.net.ClientConnectionManager;
import com.google.infinitecoin.net.NioClientManager;
import com.google.infinitecoin.net.discovery.PeerDiscovery;
import com.google.infinitecoin.net.discovery.PeerDiscoveryException;
import com.google.infinitecoin.script.Script;
import com.google.infinitecoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.infinitecoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.infinitecoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.infinitecoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.infinitecoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.infinitecoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.infinitecoin.core.Peer#ping()}.
     */
