...
package com.google.infinitecoin.tools;

import com.google.infinitecoin.core.*;
import com.google.infinitecoin.crypto.KeyCrypterException;
import com.google.infinitecoin.net.discovery.DnsDiscovery;
...
import com.google.infinitecoin.params.TestNet3Params;
import com.google.infinitecoin.protocols.payments.PaymentRequestException;
import com.google.infinitecoin.protocols.payments.PaymentSession;
import com.google.infinitecoin.store.*;
import com.google.infinitecoin.uri.BitcoinURI;
import com.google.infinitecoin.uri.BitcoinURIParseException;
...
public class WalletTool {
    ...
    private static org.infinitecoin.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            ...
            try {
                paymentRequest = org.infinitecoin.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
